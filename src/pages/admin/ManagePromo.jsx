    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Total {promotions.length} promo</p>
        </div>
        <button
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center text-xs text-gray-500 mb-3">
                    ...
                    <span>
                      {promo.start_date ? formatDate(promo.start_date) : 'N/A'}
                      {' - '}
                      {promo.end_date ? formatDate(promo.end_date) : 'N/A'}
                    </span>
                  </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  >
                    {saving ? 'Menyimpan...' : editingPromo ? 'Update' : 'Simpan'}
                  </button>
                </div>
              </form>
            </motion.div>
